...
const AdmissionForm = () => {
    ...
    const handleAdmit = event => {
        ...
        const buyerInfo={name,email,category,img}
    ...
    return (
        ...
        <div>
            <h2 className='text-primary text-3xl  text-center mt-6'>WelCome Mr/Ms. Hopefully we will buy your essential product which will be suitable for you.</h2>
            <h2 className='text-3xl font-bold text-info mt-3'>Your Selected Catagory is: Buyer</h2>
            <div className='flex justify-center items-center h-screen'>
                <div class="card w-96 bg-base-100 shadow-2xl py-4">
                    ...
                    <form onSubmit={handleAdmit}>
                        ...
                        <input type="text" placeholder="Select Your Catagory" value='buyer' name='category' class="input mt-4 input-bordered w-full max-w-xs"  required/><br />
